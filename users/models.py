...
from home.models import Level, Schools
...
class MyUser(AbstractUser):
    ...
    tsc_number = models.CharField(max_length=255, unique=True, null=True, blank=True, default=None)
    id_number = models.CharField(max_length=255, unique=True, null=True, blank=True, default=None)
    username = None
    ROLE_CHOICES = [
        ('Admin', 'Admin'),
...
class PersonalProfile(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        try:
            old_instance = PersonalProfile.objects.get(pk=self.pk)
